...
import com.yc.shiro.realm.MyShiroRealm;
...
//        shiroFilterFactoryBean.setLoginUrl("/private/unauth");
        // 登录成功后要跳转的链接
        ...
        // 登录方法
        filterChainDefinitionMap.put("/login.do", "anon"); // 表示可以匿名访问
...
//        myShiroRealm.setCredentialsMatcher(credentialsMatcher());
    ...
    public RedisCacheManager cacheManager() {
        ...
        redisCacheManager.setPrincipalIdFieldName("userNo");
