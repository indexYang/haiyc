...
public class SessionControlFilter extends AccessControlFilter {
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        ...
        PropertyUtils.copyProperties(user, subject.getPrincipal());
        ...
        if (session.getAttribute("kickout") != null) {
            ...
            if ("XMLHttpRequest".equalsIgnoreCase(((HttpServletRequest) request).getHeader("X-Requested-With"))) {
                CreateResponse.responseObject(response, AjaxResp.error(ResultCodeEnum.HASLOGIN_OTHER.code(), ResultCodeEnum.HASLOGIN_OTHER.message()), "");
            }else{
                //重定向
