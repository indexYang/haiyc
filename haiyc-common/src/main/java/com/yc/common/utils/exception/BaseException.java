...
public class BaseException extends AbstractNestedRuntimeException {
    ...
    public BaseException(ResultCodeEnum resultCode){
        ...
        this.defaultFriendlyMessage = resultCode.message();
    }
     ...
     */
    public BaseException(Integer code, Throwable cause, Object[] messageArgs) {
        super(cause);
        this.code = code;
     ...
     * @param messageArgs the argument array of the message corresponding to code
     */
    public BaseException(Integer code, String logMsg, Throwable cause, Object[] messageArgs) {
        super(logMsg, cause);
        this.code = code;
        this.messageArgs = messageArgs;
    }
     ...
     *
     */
    public BaseException(Integer code, String logMsg, Object[] messageArgs) {
        super(logMsg);
        this.code = code;
        this.messageArgs = messageArgs;
    }
     ...
     *
     */
    public BaseException(Integer code, Throwable cause, Object[] messageArgs, String defaultFriendlyMessage) {
        super(cause);
        this.code = code;
        this.messageArgs = messageArgs;
        this.defaultFriendlyMessage = defaultFriendlyMessage;
     ...
     *
     */
    public BaseException(Integer code, String logMsg, Object[] messageArgs, String defaultFriendlyMessage) {
        super(logMsg);
        this.code = code;
        this.messageArgs = messageArgs;
        this.defaultFriendlyMessage = defaultFriendlyMessage;
